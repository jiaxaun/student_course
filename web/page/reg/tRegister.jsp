...
<body>
<div class="add">
    <form id="tForm" action="${basePath}register?method=tAdd" method="post">
        <p style="font-size: 30px;text-align: center;font-family: 黑体">老师注册界面</p>
        <table class="table_add">
            <tr>
                <td>姓名</td>
                <td style="color: red;font-style:italic"><input type="text" name="tName" class="tName"></td>
            </tr>
            <tr>
                <td>账号</td>
                <td style="color: red;font-style:italic"><input type="text" name="userName" class="userName"></td>
            </tr>
            <tr>
                <td>密码</td>
                <td style="color: red;font-style:italic"><input type="password" name="pwd" value="123456" class="pwd">
                    初始密码为123456
                </td>
            </tr>
            <tr>
